...
/*   Updated: 2022/06/11 16:29:13 by nadesjar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures_p1_idle(t_game *game, t_image *img)
{
	if (game->ct.ct_idle.p1_dir == 1)
		img->img_pt.img_p1 = mlx_xpm_file_to_image(game->mlx,
				"./imgs/p1/idle/p1_idle_up_0.xpm", &img->p1.pos.x, &img->p1.pos.y);
	if (game->ct.ct_idle.p1_dir == 2)
		img->img_pt.img_p1 = mlx_xpm_file_to_image(game->mlx,
				"./imgs/p1/idle/p1_idle_do_0.xpm", &img->p1.pos.x, &img->p1.pos.y);
	if (game->ct.ct_idle.p1_dir == 3)
		img->img_pt.img_p1 = mlx_xpm_file_to_image(game->mlx,
				"./imgs/p1/idle/p1_idle_lft_0.xpm", &img->p1.pos.x, &img->p1.pos.y);
	if (game->ct.ct_idle.p1_dir == 4)
		img->img_pt.img_p1 = mlx_xpm_file_to_image(game->mlx,
				"./imgs/p1/idle/p1_idle_ri_0.xpm", &img->p1.pos.x, &img->p1.pos.y);
}
